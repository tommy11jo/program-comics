...
The name "Program Comics" also refers to how these comics are entirely programmed, including the diagrams which are made using [Manim](https://github.com/3b1b/manim). By: [Tommy Joseph](https://babbleprune.com)
