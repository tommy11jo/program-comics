...
- `Column -> Text (Above) Column | Text (Below) Column | Panel | Panel + Column`
...
In practice, `Row`s and `Column`s are not recursively defined and instead accept a prop that represents a list of components.
